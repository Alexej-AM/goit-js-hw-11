...
refs.buttonLoadEl.addEventListener("click", onLoadMoreBtn);
const BASE_URL = "https://pixabay.com/api/";
// const key = '29365633-60606ea12614ba8c3cfb381aa';
let nameSearch = refs.inputEl.value;
let lightbox;
let currentPage = 1;
...
async function fetchImages() {
    try {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}?key=29365633-60606ea12614ba8c3cfb381aa&q=${nameSearch}&image_type=photo&orientation=horizontal&safesearch=true&page=${currentPage}&per_page=${perPage}`);
        const arrayImages = await response.data.hits;
        if (arrayImages.length === 0) (0, _notiflixDefault.default).Notify.warning("Sorry, there are no images matching your search query. Please try again.");
        else if (arrayImages.length !== 0) refs.buttonLoadEl.classList.remove("invisible");
        return {
            arrayImages,
...
function onFormSubmit(e) {
    ...
    nameSearch = refs.inputEl.value;
    nameSearch;
    refs.buttonLoadEl.classList.add("invisible");
    if (nameSearch === "") {
        (0, _notiflixDefault.default).Notify.warning("\u041F\u043E\u043B\u0435 \u043F\u043E\u0448\u0443\u043A\u0443 \u043D\u0435 \u043C\u043E\u0436\u0435 \u0431\u0443\u0442\u0438 \u043F\u0443\u0441\u0442\u0438\u043C  \u041D\u0410\u041F\u0418\u0428\u0418 \u0429\u041E\u0421\u042C !!!");
        return;
    }
...
function generateMarkup({ arrayImages , totalHits  }) {
    if (currentPage === 1) (0, _notiflixDefault.default).Notify.success(`Hoooray! We found ${totalHits} images!`);
...
},{"axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","notiflix":"5WWYd","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./css/common.css":"97fCK"}],"jo6P5":[function(require,module,exports) {
...
},{}],"kaxSc":[function() {},{}],"97fCK":[function() {},{}]},["1RB6v","8lqZg"], "8lqZg", "parcelRequired7c6")
